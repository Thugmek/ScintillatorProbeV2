...
// Static allocation buffer for USBD_malloc
uint32_t usbd_static_buf[512 / 4];

// --- PCD callbacks → USBD_LL trampolines ---
...
// --- USBD_LL low-level driver interface ---

USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev) {
    hal::hpcd_USB_OTG_FS.pData = pdev;
    pdev->pData = &hal::hpcd_USB_OTG_FS;
    return USBD_OK;
}
